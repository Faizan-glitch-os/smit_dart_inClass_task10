...
void guessTheNumber() {
  ...
  while (true) {
    ...
    if (remainingAttempts != 0 && guessedByUser > guessedBySystem) {
      print('Remaining Attempts: $remainingAttempts');
      print(
          'Your entered number is Higher than the Guessed by System, enter a Low number: ');
      guessedByUser = int.parse(stdin.readLineSync()!);
    } else if (remainingAttempts != 0 && guessedByUser < guessedBySystem) {
      print('Remaining Attempts: $remainingAttempts');
      print(
          'Your entered number is lower than the Guessed by System, enter a High number: ');
      guessedByUser = int.parse(stdin.readLineSync()!);
...
int endGame(int guessed) {
  print('The Number guessed by the system was: $guessed');
  return 0;
}
